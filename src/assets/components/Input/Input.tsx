...
const Input = ({ onBlur, placeholder, type = 'text', onChange, name, label, /* id, */ /* field */ /* required = true */ value }: InputProps) => {
  ...
  return (
    <label className="flex flex-col text-lg text-center font-medium leading-6 text-white">
      ...
      <input
        ...
        // id={id}
        type={type}
        className="mt-2 min-w-[500px] flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-white sm:text-sm sm:leading-6"
        value={value}
        // {...field}
