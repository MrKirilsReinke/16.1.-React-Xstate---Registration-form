...
import EnteringEmailFormPart from './Forms/EnteringEmailFormPart';
import EnteringPersonalInfoFormPart from './Forms/EnteringPersonalInfoFormPart';
import EnteringContactInfoFormPart from './Forms/EnteringContactInfoFormPart';
import FormCompletionFormPart from './Forms/FormCompletionFormPart';
import FormSubmittedFormPart from './Forms/FormSubmittedFormPart';
...
function FormikApp() {
  ...
  const onSubmit = (values: FormValues, { resetForm } /* { setSubmitting } */) => {
    send({
...
// import EnteringEmailForm from './Forms/EnteringEmailForm';
